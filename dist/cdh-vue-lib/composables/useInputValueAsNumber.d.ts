 ...
 */
declare function useInputValueAsNumber(event: Event): number;
/**
 *
 ...
 */
declare function useInputValueAsNumberOrNull(event: Event): number | null;
export { useInputValueAsNumber, useInputValueAsNumberOrNull };
//# sourceMappingURL=useInputValueAsNumber.d.ts.map